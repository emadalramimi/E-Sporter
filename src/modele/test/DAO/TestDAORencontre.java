...
/**
 * Classe de tests de la classe DAORencontre.
 * @see modele.DAO.DAORencontre
 */
public class TestDAORencontre {
	...
	/**
	 * Teste la levée d'exception lors de l'ajout d'une rencontre avec trop d'équipes
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#ajouter()
	 */
	...
	/**
	 * Teste la levée d'exception lorsque le tournoi n'existe pas.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#resetEquipeGagnante()
	 */
	...
	/**
	 * Teste la levée d'exception lorsque le tournoi est cloturé.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#resetEquipeGagnante()
	 */
	...
	/**
	 * Teste la levée d'exception lorsque l'utilisateur n'est pas un arbitre.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#resetEquipeGagnante()
	 */
	...
	/**
	 * Teste la réinitialisation de l'équipe gagnante.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#resetEquipeGagnante()
	 */
	@Test
	...
	/**
	 * Teste le choix de l'équipe gagnante.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#setEquipeGagnante()
	 */
	@Test
	...
	/**
	 * Teste la levée d'exception lorsque l'équipe choisie n'existe pas.
	 * @throws Exception
	 * @see modele.DAO.DAORencontre#setEquipeGagnante()
	 */
	@Test(expected = IllegalArgumentException.class)
	...
	public void tearsDown() throws Exception {
		...
		this.daoRencontre.getTout().stream()
		...
		this.daoTournoi.getTout().stream()
